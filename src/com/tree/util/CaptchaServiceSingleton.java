...
public class CaptchaServiceSingleton extends ListImageCaptchaEngine {    
    ...
    private static final Integer MAX_WORD_LENGTH = new Integer(4);     //最多字的个数
   
    private static final Integer IMAGE_WIDTH = new Integer(120);       //图片的长度
   
    private static final Integer IMAGE_HEIGHT = new Integer(40);     //图片的高度
   
    private static final Integer MIN_FONT_SIZE = new Integer(20);     //最小字的大小
   
    private static final Integer MAX_FONT_SIZE = new Integer(20);    //最大字的大小
	...
	private static String value="captcha";    
